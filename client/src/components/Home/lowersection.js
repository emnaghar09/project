...
<img  className="lowimg" src={image3} width='350' height='200' alt='low '/>
<img  className="lowimg" src={image4}  width='350' height='200' alt='low '/>
<img   className="lowimg" src={image5} width='350' height='200' alt='low ' />

<img  className="lowimg" src={image9} width='350' height='200' alt='low ' />
 <img  className="lowimg" src={image8} width='350' height='200'  alt='low '/>
 <img className="lowimg"  src={image10} width='350' height='200' alt='low ' />
</div>
...
<img src="https://www.codsils.com/wp-content/uploads/2019/03/Blog-2-new.jpg" className="lowerSectionImg" alt='low '></img>
</p>
</div>
<div className="lowercols">
<p className="lowerhalfcolsTwo">
<img src="https://static9.depositphotos.com/1028911/1113/i/600/depositphotos_11133731-stock-photo-diet-concept.jpg" className="lowerSectionImgTwo" alt='low' ></img>
</p>
